/*
 ESP8266 MQTT/Homie control of Garage Door Opener
 Shung Chieh 11/5/2016
 
 This attempts to connect to the mqtt broker without blocking the main loop.
 Upgrading to v2.0 of Homie
...
#define DOORF_DIS 5
#define DOORF_TRIG 4
#define DOORG_SENS 14 // pullup
#define DOORF_SENS 16 // pullup

#define DOOR_LIMIT 1E8
...
// set up door switch inputs
  pinMode(DOORG_SENS, INPUT_PULLUP); // Initialize door switches 1=OPEN
        ...
        if (value ==  "true") {
          switch (door) {
            case DOORF_TRIG:
              ...
              Homie.setNodeProperty(garageFNode,"disable","true");

              break;
            case DOORG_TRIG:
              disableDoor(DOORG_DIS, &(doorg_dis));
              Homie.setNodeProperty(garageGNode,"disable","true");
              break;
          }
        } else {
          switch (door) {
